...
function __findEndpoint(masterClient, endpointUrl, params, callback) {
    ...
    const tasks = [
        (innerCallback) => {
            ...
            client._connectStep2(endpointUrl, (err) => {
                if (err) {
...
class ClientBaseImpl extends node_opcua_common_1.OPCUASecureObject {
    ...
    connect(...args) {
        ...
        if (!this.serverCertificate && (forceEndpointDiscoveryOnConnect || this.securityMode !== node_opcua_service_secure_channel_1.MessageSecurityMode.None)) {
            debugLog("Fetching certificates from endpoints");
            return this.fetchServerCertificate(endpointUrl, (err, adjustedEndpointUrl) => {
                if (err) {
