...
import { AddressSpace, UAMethod } from "../address_space_ts";
...
export declare function getMethodDeclaration_ArgumentList(addressSpace: AddressSpace, objectId: NodeId, methodId: NodeId): {
...
export declare function build_retrieveInputArgumentsDefinition(addressSpace: AddressSpace): (objectId: NodeId, methodId: NodeId) => Argument[];
