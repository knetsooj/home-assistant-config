...
exports.sameDataValue = exports.sameStatusCode = exports.timestampHasChanged = exports.serverTimestampHasChanged = exports.sourceTimestampHasChanged = exports.extractRange = exports.apply_timestamps_no_copy = exports.apply_timestamps = exports.DataValue = exports.decodeDataValue = exports.encodeDataValue = void 0;
/**
...
class DataValue extends node_opcua_factory_1.BaseUAObject {
    ...
    constructor(options) {
        ...
        this.statusCode = node_opcua_status_code_1.coerceStatusCode(options.statusCode || node_opcua_status_code_1.StatusCodes.Good);
        this.sourceTimestamp = options.sourceTimestamp ? node_opcua_date_time_1.coerceDateTime(options.sourceTimestamp) : null;
        this.sourcePicoseconds = options.sourcePicoseconds || 0;
        this.serverTimestamp = options.serverTimestamp ? node_opcua_date_time_1.coerceDateTime(options.serverTimestamp) : null;
